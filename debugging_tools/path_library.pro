...
;    in the IDL console. Then you can start adding markers with their paths.
  ...
  if hostname eq 'altair' then hostname = 'arcturus'
  ...
  case strlowcase(marker) of
    'idl_sav' : $
      ...
      case hostname of
        'arcturus' :     p = [$
                               '/Users/gagne/Documents/IDL/IDL_sav/' $
                              ]
        else : goto, badhost
      endcase
    end ;idl_sav
     ...
     '2mass_data' : $
      ...
      begin
        case hostname of
          ...
          'arcturus' : p = ['/Users/gagne/Dropbox_New/Dropbox/Univ/Doctorat/M Stars/']
          else : goto, badhost 
        endcase
      end ;Mstars
      'mstruc' : $
      ...
      begin
        case hostname of
          ...
          'Charles-PC' : p = ['C:\Users\Victor\Desktop\PHY Hiver 2015\PHY3030\Brutes\']
          else : goto, badhost 
        endcase
      end ;data
      'cpapirdata' : $
      ...
      begin
        case hostname of
          ...
          'arcturus' : p = ['/Users/gagne/Dropbox/']
          else : goto, badhost 
        endcase
      end ;desktop
      'logfiles': $
      ...
      'my_reductions': $
        begin
          case hostname of
            'arcturus' : p = [gpath('data')+'my_reductions'+path_sep()]
            'Charles-PC' : p = ['C:\Users\Victor\Desktop\PHY Hiver 2015\PHY3030\Resultats\']
          else : goto, badhost
        endcase
      end;MY_REDUCTIONS
      'my_data': $
        begin
        case hostname of
          'arcturus' : p = [gpath('data')+'my_data'+path_sep()]
          else : goto, badhost
        endcase
      end;MY_DATA
      'std_opt': $
        begin
        case hostname of
          'arcturus' : p = [gpath('data')+'Models'+path_sep()+'Spectroscopic_Standards'+path_sep()+'Optical'+path_sep()]
          'Charles-PC' : p = ['C:\Users\Victor\Desktop\PHY Hiver 2015\PHY3030\Standard optique\']
          else : goto, badhost
        endcase
      end;STD_OPT
      'templates_opt': $
        begin
        case hostname of
          'arcturus' : p = [gpath('data')+'Spectral Library'+path_sep()+'Templates_NEW_OPT'+path_sep()]
          'Charles-PC' : p = ['C:\Users\Victor\Desktop\PHY Hiver 2015\PHY3030\Templates_NEW_OPT\']
          else : goto, badhost
        endcase
      end;TEMPLATES_OPT
      'templates_nir': $
        begin
        case hostname of
          'arcturus' : p = ['/Users/gagne/Documents/Donnees/Spectral Library/Templates_NIR_Kelle_Jan2015/']
          else : goto, badhost
        endcase
      end;TEMPLATES_NIR_KELLE
      'templates_nir_kelle': $
        begin
        case hostname of
          'arcturus' : p = ['/Users/gagne/Documents/Donnees/Spectral Library/Templates_NIR_Kelle_Jan2015/']
      ...
      'idl_csv': $
        begin
        case hostname of
          'Charles-PC' : p = ['C:\Users\Victor\Desktop\PHY Hiver 2015\PHY3030\Log Observation\']
          'arcturus' : p = ['/Users/gagne/Documents/IDL/IDL_csv/']
          else : goto, badhost
        endcase
      end;IDL_CSV
      'idl_graphs': $
        begin
        case hostname of
          'arcturus' : p = ['/Users/gagne/Documents/IDL/IDL_graphs/']
          'Charles-PC' : p = ['C:\Users\Victor\Desktop\PHY Hiver 2015\PHY3030\Graphs\']
          else : goto, badhost
        endcase
      end;IDL_GRAPHS
      'reduc_data': $
        begin
        case hostname of
          'arcturus' : p = ['/Users/gagne/Dropbox/Data_Repository/REDUCED/']
          else : goto, badhost
        endcase
      end;IDL_GRAPHS
      'b7_analyze': $
        begin
        case hostname of
          'arcturus' : p = [gpath('my_data')+'BANYANVII_ANALYZE/']
          else : goto, badhost
        endcase
      end;IDL_GRAPHS
